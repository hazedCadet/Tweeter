...
class TwitterAPICaller: BDBOAuth1SessionManager {    
    static let client = TwitterAPICaller(baseURL: URL(string: "https://api.twitter.com"), consumerKey: "jXglDPKDJcnv4PcY5Cdylq26s", consumerSecret: "Y3oXtS621ka1MCqSQzlTi55uD17WDAMKeJURpyFMFUT3UL9jpr")
    var loginSuccess: (() -> ())?
